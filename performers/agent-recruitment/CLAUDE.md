# agent-recruitment — Claude Instructions

This performer is part of the agent-bot multi-agent pack system.

## Invocation
Invoked via `dispatch('agent-recruitment', documentText)` from /root/hydrabot/bots/agent-bot/bot.mjs

## Working directory
/root/bot-circus/performers/agent-recruitment/
