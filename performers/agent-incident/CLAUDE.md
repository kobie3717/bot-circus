# agent-incident — Claude Instructions

This performer is part of the agent-bot multi-agent pack system.

## Invocation
Invoked via `dispatch('agent-incident', documentText)` from /root/hydrabot/bots/agent-bot/bot.mjs

## Working directory
/root/bot-circus/performers/agent-incident/
