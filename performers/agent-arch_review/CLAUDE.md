# agent-arch_review — Claude Instructions

This performer is part of the agent-bot multi-agent pack system.

## Invocation
Invoked via `dispatch('agent-arch_review', documentText)` from /root/hydrabot/bots/agent-bot/bot.mjs

## Working directory
/root/bot-circus/performers/agent-arch_review/
